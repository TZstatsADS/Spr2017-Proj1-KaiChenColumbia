...
corpus.s.list <- corpus.s.list[nonempty1[1:n.corpuss], ]  # 相应移除相应文档row
...
Since steps are similar, I will provide the code and results without any explanation.
